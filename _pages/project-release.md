...
<figure class="align-center" style="max-width: 100%; margin: 0 auto;">
    <img src="{{ site.url }}{{ site.baseurl }}/assets/release/spot_smpc/spot_smpc_lq.jpg" alt="Spot robot performing dynamic whole-body loco-manipulation" style="width: 100%; height: auto;">
</figure>
